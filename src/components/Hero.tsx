...
export default function Hero() {
  ...
  return (
    <div className="relative w-full border">
      <section className="relative w-full h-[100vh] mt-[-140px] overflow-hidden z-[-1]">
        ...
        <div className="relative z-20 flex items-center justify-center h-full bg-black/40 px-4">
          <div className="flex flex-col items-center justify-center text-center text-white max-w-3xl">
            <Image
              ...
              className="mb-[10px]"
            />
            <h1 className="text-4xl sm:text-6xl font-semibold text-[#FFFFFF] tracking-[0.025em]">
              Reliable House <br /> Cleaning Services
            </h1>
            <p className="mt-[10px] sm:text-lg sm:text-xl font-thin bg-[#00000070] px-12 py-[8px] rounded-[8px]">
              Enjoy a fresh clean home for you to rest.
              <br />
              Enhance productivity at a fresh commercial office.
              <br />
